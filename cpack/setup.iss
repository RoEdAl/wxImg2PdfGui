...
AppID={#Img2PdfBase}
AppName={cm:img2pdf}
AppVerName={cm:img2pdf} {#Img2PdfExeArch} {#Img2PdfFileVersion}
AppVersion={#Img2PdfFileVersion}
AppCopyright={#Img2PdfFileCopyright}
AppPublisher={#Img2PdfFileCompany}
VersionInfoProductName={#Img2PdfBase} ({#Img2PdfExeArch})
...
ArchitecturesAllowed={#Img2PdfExeArch}
ArchitecturesInstallIn64BitMode={#Img2PdfExeArch}
TimeStampsInUTC=yes
...
[Run]
Components: gui; Filename: {app}\{#Img2PdfBase}-frontend.exe; Flags: PostInstall RunAsOriginalUser NoWait; Description: {cm:gui_run}; 
...
const
    VC_REG_KEY = 'SOFTWARE\Microsoft\VisualStudio\14.0\VC\Runtimes\{#Img2PdfExeArch}';
...
begin
  ...
  if not Result then
    SuppressibleMsgBox(
        FmtMessage(SetupMessage(msgWinVersionTooLowError), ['Visual C++ 2015-2022 Redistributable ({#Img2PdfExeArch})', '14.0']),
