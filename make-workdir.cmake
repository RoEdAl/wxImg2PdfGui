...
SET(URL_WXWIDGETS "https://github.com/RoEdAl/wxwidgets-builds/releases/download/v${WXWIDGETS_VERSION}-build3")
IF(INSTALL_MSVC)
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-vc-dbg-${WXWIDGETS_VERSION}-win64.7z 8b335d35d0a9bb1890a7a9352388188ce498a3c9 "wxWidgets dev libraries [MSVC x64]")
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-vc-${WXWIDGETS_VERSION}-win64.7z 7642cd35c1737ce2dca4d960c92f658fdd52d12b "wxWidgets libraries [MSVC x64]")
ENDIF()

IF(INSTALL_MINGW64)
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-gcc-dbg-${WXWIDGETS_VERSION}-win64.7z e510c4f8439c2bc77f2bcc76468c9382b379f8e2 "wxWidgets dev libraries [MinGW64]")
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-gcc-${WXWIDGETS_VERSION}-win64.7z 38ef888daf1c7112720634e71314402f8fea2124 "wxWidgets libraries [MinGW64]")
